...
<div class="container mt-3">
        <nav class="menu">
            <div class="row text-center">
                ...
                <a href="activity.php" class="btn btn-warning font-weight-bold col-2 offset-1">Activity</a>
                            ...
                            echo "<table class='table table-bordered table-striped mt-5'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['name'] . "</td>";                                        
                                        echo "<td>";
                                        echo '<a href="delete-order.php?name=' . $row['name'] . '" class="btn btn-sm btn-danger">Delete</a>';
                                        echo "</td>";
                                    echo "</tr>";
                                }
                                    echo "<tr>";
